...
<div style="height:40px;"></div>
    <div id='order'>
        ...
        <span id='o-title' style="float:right;"><a href="/home/insert" style="color:blue;">添加收货地址</a></span>
		    ...
		    <img src="/static/home/images/pstime.png" alt="">		 	
		 	<div id='opcon'>
				 	<div class='o-con-d'>
				 		...
				 		<span class='o-price'>￥0.00</span><span class='o-cnt'> x 1</span><span class='o-state'>库存：{{$goods->stock}}</span>
				 	</div>
		 ...
		 <div id='o-end'>
		 	<div id='o-end1'><span>应付总额：</span> <b>￥0.00</b></div>
		 ...
		 <div style="float:right;margin-right:180px;padding-top:20px;">
            <a class='btn btn-info quxiao' style="margin-right:20px;" href="">取消</a>
		 	<a class='btn btn-info' sum="{{$goods->price}}" href="">提交订单</a>
		 </div>
        ...
        $('.btn').eq(1).click(function(){
            ...
            var adr = adr[1];
            console.log(user,tel,val,adr);
            $.post('/home/chous',{user:user,tel:tel,adr:adr,msg:val},function(data){
                console.log(data);
                if(data == '0'){ 
                    layer.open({
                        title: '错误提示...',
