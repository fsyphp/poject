...
<div style="height:40px;"></div>
    <div id='order'>
        ...
        <span id='o-title' style="float:right;"><a href="/home/insert" style="color:blue;">添加收货地址</a></span>
		 ...
		 <div id='o-content'>
		    <img src="/static/home/images/pstime.png" alt="">		 	
		 	<div id='opcon'>
				 	<div class='o-con-d'>
				 		<img style="width:100px;" class='o-pic' src="{{$goods->img}}" alt="">
				 		<div class='o-m'>
					 		<span class='o-name'>
					 		   {{$goods->title}}
					 		</span>
				 		...
				 		<span class='o-price'>￥{{$goods->price}}</span><span class='o-cnt'> x 1</span><span class='o-state'>库存：{{$goods->stock}}</span>
				 	</div>
         ...
         <div style="height:20px;"></div>
		 	 <div id='o-zafei1' style="padding-bottom:-40px;">
		 	 	<div class='o-zafei'>￥{{$goods->price}}.00</div>
		 	 </div>
		 	 <div id='o-zafei2'>
		 	 	<div class='o-zafei'>共 1 件商品，总金额：</div>
		 	 </div>
		 	 <div style='clear:both;'></div>
		 </div>
		 <div id='o-end'>
		 	<div id='o-end1'><span>应付总额：</span> <b>￥{{$goods->price}}积分</b></div>
		 ...
		 <div style="float:right;margin-right:180px;padding-top:20px;">
            <a class='btn btn-info quxiao' style="margin-right:20px;" href="">取消</a>
		 	<a class='btn btn-info' sum="{{$goods->price}}" href="/home/create">提交订单</a>
		 </div>
        ...
        $('.btn').eq(1).click(function(){
            ...
            var adr = adr[1];
            $.post('/home/huan',{total:sum,user:user,tel:tel,adr:adr,msg:val},function(data){
                console.log(data);
                if(data == '0'){ 
                    layer.open({
                        title: '错误提示...',
