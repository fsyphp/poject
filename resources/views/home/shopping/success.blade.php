...
<div id="container">
    ...
    <div class="btn-area mb10">
        <a class="btn-ordershow" href="" clstag="pageclick|keycount|trade_201602181|31">查看订单</a>
                ...
                <i></i>
                            再次购买
		    						    ...
		    						    <ul class="list-order">
			    					<li class="li-st">
					<div class="fore1">订单号：<a href="">{{$num}}</a></div>
					<!-- 货到付款 -->
										   <div class="fore2">订单总金额：<strong class="ftx-01">{{$total}}元</strong></div>
					   									</li>
						</ul>
		<!-- 在线支付按钮  -->
				<div id="bookDiv"></div>
        ...
        <div class="d-tips">
            <span class="d-tips-cont">
                ...
                进行退款操作。点此查看京东平台“
			    <a class="ftx-05" target="_blank" href="">谨防诈骗公告声明</a>
			    ”
            </span>
        </div>
 </div>
    		<div class="qr-code"><a class="code" href="javascript:void(0)"><img alt="" src="/static/home/images/5435f1eeNc4bfcf9e.jpg"></a><a class="sao02" href="javascript:void(0)"></a></div>
    	</div>
    	<div class="o-mb">完成支付后，您可以：
                  <a href="" clstag="pageclick|keycount|trade_201602181|33">继续购物</a>&nbsp;&nbsp;<a href="" clstag="pageclick|keycount|trade_201602181|34">问题反馈</a>
    	</div>
    </div>
